...
const NewTask = ({ closeModal, passedMethod }) => {
                        ...
                        <div className="relative p-6 flex-auto">
                            <form onSubmit={handleSubmit} className='space-y-6'>
                                ...
                                <div className="flex items-center justify-end px-6 pt-4 border-t border-solid border-slate-200 rounded-b">
                                    <button
                                        className="w-full hover:bg-red-500 hover:text-white rounded text-red-500 background-transparent font-bold uppercase px-6 py-3 text-sm outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
                                        type="button"
                                        onClick={closeModal}>
                                        Close
                                    </button>
